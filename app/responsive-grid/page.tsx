    ...
    <>
      ...
      <div className=" mx-auto sm:grid sm:grid-rows-auto  sm:grid-cols-[65vw_30vw] md:grid-cols-[70vw_25vw] lg:grid-cols-[60vw_30vw] sm:place-items-center ">
        <UniqueClipChoice
          speed={30}
          shape="circle"
          className="max-sm:w-[90vw] min-sm:max-lg:w-[70vw] lg:w-[60vw]"
        />
        <div className="max-sm:hidden max-w-prose text-center">
          <h2 className="text-xl font-semibold mb-4">
            Balanced Responsive Block
          </h2>
          <ReadMore>
            <p className=" line-clamp-4 md:line-clamp-5 overflow-ellipsis">
              {" "}
              These are some sample content throughout the pages manipulating
              responsive phase. On larger screens it will take up proportion of
              viewport or container size. Aspect ratio scenario relevance . On
              smaller screens, it will stay hidden.
            </p>
          </ReadMore>
        </div>
      </div>
      <div className="mx-auto  w-[90vw] max-sm:aspect-square lg:w-[90vw] sm:aspect-video my-10">
        ...
        >
          <h1 className=" font-bold  text-[#7f5522] ">
      ...
      <ExplodeStack>
        ...
        <>
          <p className="text-xl text-green-400">single</p>
          <img
            src="https://picsum.photos/300/300"
            alt="Logo"
            className="w-12 h-12"
