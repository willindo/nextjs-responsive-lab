...
export default function ShadowDemo() {
  return (
    <div className=" md:grid md:grid-cols-2 md:grid-rows-2 items-center gap-10 p-10 bg-gray-100 ">
      ...
      <div className=" row-start-2  flex flex-col items-center text-center">
